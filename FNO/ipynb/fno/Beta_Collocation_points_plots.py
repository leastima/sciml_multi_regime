...
REGIME_LABEL_STYLE = {"fontsize": 16, "fontweight": "bold", "color": "black"}
...
REGIME_POSITION_FRAC_MAP = {
    ...
    # "reaction": {1: (0.15, 0.6), 2: (0.8, 0.6), 3: (0.8, 0.11)},
    # "wave": {1: (0.25, 0.6), 2: (0.85, 0.6), 3: (0.8, 0.06)},
}
...
def main():
    ...
    for func, json_file_path in datasets.items():
        ...
        for metric, metric_title in zip(metric_list, metric_title_list):
            ...
            overlay = regime_overlay # if metric in ("training_loss", "test_error") else None
            plot_2d_phase(
                phase2d,
                x_axis,
                y_axis,
