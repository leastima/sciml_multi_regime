...
do
    if [ $interrupted -eq 0 ]; then  # Check if Ctrl+C has been pressed
        ...
        python run_experiment.py \
            ...
            --opt $opt \
            --opt_params switch_epochs $switch_epochs adam_lr $adam_lr lbfgs_history_size 100 switch_epoch_lbfgs $switch_epoch_lbfgs switch_epoch_nncg $switch_epoch_nncg precond_update_freq $precond_update_freq nncg_rank $nncg_rank nncg_mu $nncg_mu \
            --num_layers $n_layers \
